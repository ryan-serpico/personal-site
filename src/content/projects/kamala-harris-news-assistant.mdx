...
import kamalaProjImage from '../../assets/images/kamala-harris-news-assistant.png';

<Image src={kamalaProjImage} alt="Kamala Harris News Assistant interface showing Q&A chatbot with Chronicle reporting" />
